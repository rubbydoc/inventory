 ...
 */
public class CashierTransactions extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Transaction ID", "Inventory ", "Quantity", "Price", "Discount", "Total", "Cashier Name", "Date", "Time"
            }
        ));
        ...
        jLabel6.setText("CASHIER TRANSACTIONS");
...
//        }
        try {
            ...
            while (rs.next()) {
                if (value2.equals(rs.getString(2))) {
                    query("select CTransactionID, b.ProductName, a.Quantity,a.Price, a.Discount, a.Total, u.FirstName, u.LastName, Date, Time from ctransactions as a join inventory as b on a.InventoryID = b.InventoryID join users as u on u.UserID = a.UserID WHERE u.FirstName='" + rs.getString(2) + "'");
    ...
    private void jTextField1CaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_jTextField1CaretUpdate
        ...
        query("select CTransactionID, b.ProductName, a.Quantity,a.Price, a.Discount, a.Total, u.FirstName, u.LastName, Date, Time from ctransactions as a join inventory as b on a.InventoryID = b.InventoryID join users as u on u.UserID = a.UserID WHERE  Date LIKE " + "'" + val + "%'");
    ...
    public void transactions() {
        ...
        try {
            ...
            Statement stmt = c.connect().createStatement();
            ResultSet rs = stmt.executeQuery("select CTransactionID, b.ProductName, a.Quantity,a.Price, a.Discount, a.Total, u.FirstName, u.LastName, Date, Time from ctransactions as a join inventory as b on a.InventoryID = b.InventoryID join users as u on u.UserID = a.UserID");
            DefaultTableModel tm = (DefaultTableModel) jTable1.getModel();
            tm.setRowCount(0);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CashierTransactions.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
