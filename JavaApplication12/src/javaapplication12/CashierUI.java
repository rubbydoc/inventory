...
//        target.setText(new LoginUI().cashier());
    ...
    private void initComponents() {
        ...
        transaction.setBackground(new java.awt.Color(240, 240, 240));
        transaction.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        transaction.setBorder(javax.swing.BorderFactory.createEmptyBorder(1, 1, 1, 1));
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(salesTotal, javax.swing.GroupLayout.DEFAULT_SIZE, 39, Short.MAX_VALUE)
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(due, javax.swing.GroupLayout.DEFAULT_SIZE, 39, Short.MAX_VALUE)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addGap(0, 0, Short.MAX_VALUE)
                        .addComponent(jLabel6)))
                .addGap(11, 11, 11))
        ...
        dates.setBackground(new java.awt.Color(240, 240, 240));
        dates.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        dates.setBorder(javax.swing.BorderFactory.createEmptyBorder(1, 1, 1, 1));
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(transaction, javax.swing.GroupLayout.PREFERRED_SIZE, 140, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addGroup(layout.createSequentialGroup()
                        .addComponent(dates, javax.swing.GroupLayout.PREFERRED_SIZE, 140, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
...
return s;
    ...
    private void jButton8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton8ActionPerformed
        ...
        if (option == JOptionPane.OK_OPTION) {
            try {
                PreparedStatement ps = c.connect().prepareStatement("update users set password=? where username=? ");
...
JOptionPane.showConfirmDialog(null, 
                "You changed your password.", "Succesful!", JOptionPane.DEFAULT_OPTION);
...
if (transaction.getText().equals("") || flag==false ){
JOptionPane.showConfirmDialog(null, 
...
//double discounted = sales-dis;
        ...
        try {
            ...
            ResultSet rs = stmt.executeQuery("select Sum(discount) as sumdiscount from dailySales where transaction_number =" + tran);
...
//        String des = jTable2.getModel().getValueAt(row, 1).toString();
    ...
    private static javax.swing.JTextField dates;
    ...
    private static javax.swing.JTextField transaction;
